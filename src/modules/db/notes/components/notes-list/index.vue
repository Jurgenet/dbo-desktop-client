  ...
  <div class="q-gutter-y-sm">
    ...
    <div class="row no-wrap queryMarkers">
      <MarkersUi.MarkersSelector
        :markers-titles="notesStore.queryMarkers"
        no-create
        clearable
        dense
...
const emits = defineEmits<{
  (e: 'open', note: notesDto.INote, inBackground: boolean): void
  (e: 'pin', note: notesDto.INote): void
}>()

function onOpenNote (note: notesDto.INote, isInBackground: boolean) {
